<?php
/**
 * COGS Management Core Functionality for Business Report Plugin
 * (Moved from cogs-management.php)
 *
...
function br_cogs_admin_enqueue_scripts( $hook ) {
    // Enqueue script if on the new Product Report page or the Settings page
	if ( 'business-report_page_br-product-report' !== $hook && 'business-report_page_br-settings' !== $hook ) {
		return;
	}
...
/**
 * =================================================================================
 * 3. WOOCOMMERCE INTEGRATION - ADD/SAVE COGS FIELD
 * =================================================================================
 */
...
/**
 * =================================================================================
 * 4. SETTINGS API CALLBACKS (for settings-page.php)
 * =================================================================================
 */
...
/**
 * =================================================================================
 * 5. AJAX HANDLER FOR APPLYING RULES
 * =================================================================================
 */
